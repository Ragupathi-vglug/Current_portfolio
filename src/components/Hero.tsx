...
const Hero: React.FC = () => {
  ...
  const fullText = 'Aspiring Backend Developer | Data Analyst | Frontend Enthusiast';
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-800 dark:text-white mb-6">
            <span className="block">Ragupathi</span>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            M.Sc. Information Technology postgraduate passionate about creating innovative solutions 
            through backend development, data analysis, and modern web technologies.
          </p>
